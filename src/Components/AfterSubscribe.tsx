    ...
    return (
        <div className="after-container">
            <div className="after-text">
                ...
                <p className="after-message">A confirmation email has been sent to <span style={{fontWeight: 700}}>ash@loremcompany.com</span>. Please open it and click the button inside to confirm your subscription</p>
            </div>
